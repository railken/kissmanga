...
use DateTime;
use Railken\Kissmanga\Exceptions\KissmangaResourceParserDateNotSupported;
use Railken\Kissmanga\Traits\ParseDateTrait;
use Railken\Bag;

class KissmangaResourceParser
{
    use ParseDateTrait;
    ...
    public function parse($html)
    {
        ...
        if (!$head->filter("[property='og:url']")->getNode(0)) {
            throw new Exceptions\KissmangaResourceParserInvalidUrlException();
        }

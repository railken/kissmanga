...
namespace Railken\Kissmanga\Traits;

use DateTime;
use Railken\Kissmanga\Exceptions\KissmangaParserDateNotSupportedException;
    ...
    public function parseDate($date)
    {
        ...
        if (preg_match("/^([0-9]*) ([\w]*) ago$/", $date, $res)) {
            ...
            if (in_array($res[2], $types)) {
                ...
                throw new Exceptions\KissmangaParserDateNotSupportedException($res[2]);
            }
        }
